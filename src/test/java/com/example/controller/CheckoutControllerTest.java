...
public class CheckoutControllerTest {
    ...
    public void checkout() throws Exception {
        ...
        assertEquals(Character.valueOf('A'), actualShoppingCart.getShoppingCartItems().get(0).getStockKeepingUnit().getSkuId());
        assertEquals(1, actualShoppingCart.getShoppingCartItems().get(0).getStockKeepingUnit().getQuantity());
    }
